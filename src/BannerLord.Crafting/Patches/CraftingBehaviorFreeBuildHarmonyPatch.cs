...
namespace BannerLord.Crafting.Patches
{
    ...
    public static class CraftingBehaviorFreeBuildHarmonyPatch
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            if (AccessTools.DeclaredMethod(typeof(CraftingResearchCampaignBehavior), nameof(CraftingResearchCampaignBehavior.HandleResearchForCrafting)) is not { } handleResearchForCrafting)
                return instructions.HandleTranspilerFailure("CraftingBehaviorPatch:HandleResearchForCrafting not found");
            ...
            try
            {
                ...
                var newInstructions = new List<CodeInstruction>
                {
                    ...
                    new(OpCodes.Call, handleResearchForCrafting)
                };
